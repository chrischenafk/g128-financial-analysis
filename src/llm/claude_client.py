...
_TRIGGER_MESSAGE_PROCESSED = (
    ...
    "Do NOT write a numbered section heading for the Action Plan (e.g. '11. Recommended Action Plan') — "
    "build_doc.js renders the action_plan array as its own titled section automatically. "
    "Writing the heading in sections[] creates an empty duplicate.\n"
    "In key_insights headlines: use the product's plain English name (e.g. 'Black American Heritage flag') "
    "not the SKU ID (e.g. 'FG-3BLAH-4P2'). Keep headlines under 12 words — punchy, not technical. "
    "Put the SKU ID and pipeline rule details in the detail field, not the headline. "
    "Example good headline: 'Black American Heritage absorbs half the ad budget at 7.7% margin'. "
    "Example bad headline: 'FG-3BLAH-4P2 absorbs 49% of ad budget -- pipeline rule A, both_lenses_down'.\n"
    "{chart_note}\n"
    "The package is the source of truth — do not recompute any metric."
)
_CHART_NOTE_PRESENT = (
